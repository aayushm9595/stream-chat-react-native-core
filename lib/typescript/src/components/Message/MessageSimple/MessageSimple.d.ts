...
import { ForwardedMessageProps } from './MessageContent';
...
export declare type MessageSimpleProps<At extends UnknownType = DefaultAttachmentType, Ch extends UnknownType = DefaultChannelType, Co extends string = DefaultCommandType, Ev extends UnknownType = DefaultEventType, Me extends UnknownType = DefaultMessageType, Re extends UnknownType = DefaultReactionType, Us extends UnknownType = DefaultUserType> = ActionProps & MessageProps<At, Ch, Co, Ev, Me, Re, Us> & {
     ...
     * */
    MessageAvatar?: React.ComponentType<ForwardedMessageProps<At, Ch, Co, Ev, Me, Re, Us>> & {
        showAvatar?: boolean;
    };
    /**
     ...
     * */
    MessageContent?: React.ComponentType<ForwardedMessageProps<At, Ch, Co, Ev, Me, Re, Us>>;
    /**
     ...
     *
     * */
    MessageStatus?: React.ComponentType<ForwardedMessageProps<At, Ch, Co, Ev, Me, Re, Us>>;
     ...
     * */
    onLongPress?: (message: Message<At, Ch, Co, Ev, Me, Re, Us>, event: GestureResponderEvent) => void;
    /**
     ...
     * @param event   Event object for onLongPress event
     * */
    onPress?: (message: Message<At, Ch, Co, Ev, Me, Re, Us>, event: GestureResponderEvent) => void;
    /**
     ...
     */
    ReactionList?: React.ComponentType<ReactionListProps<At, Ch, Co, Me, Re, Us>>;
